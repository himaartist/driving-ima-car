...
# === Carregar imagens ===
img_jogador = pygame.image.load("dess.png")
#converte pra 40x40
img_jogador = pygame.transform.scale(img_jogador, (50, 70))

carros = [pygame.transform.scale(pygame.image.load("asgore.png"), (40, 40))]
personagem = [pygame.transform.scale(pygame.image.load("dess.png"), (40, 40))]
...
try:
    mixer.music.load("")#("Asgore Runs Over Dess With Lyrics  Deltarune - Bub8les (youtube).mp3")  # Carregar o arquivo de música
    mixer.music.set_volume(0.5)  # Definir o volume para 50%
    mixer.music.play()  # Tocar a música
...
def criar_obstaculo():
    ...
    carro_img = random.choice(carros)#img aleatória
    rect = pygame.Rect(x, -40, 40, 40)


    return {"rect": rect, "img": carro_img}
